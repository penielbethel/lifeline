...
const AdminDashboard = () => {
    ...
    const fetchDashboardData = async () => {
        try {
            ...
            // Fetch Blogs
            try {
                const blogsRes = await axios.get(`${API_URL}/admin/blogs`, config);
        ...
        <div style={{ minHeight: '100vh', backgroundColor: '#F4F4F4' }}>
            ...
            <section style={{ padding: '3rem 0' }}>
                <div className="container">
                    ...
                    {/* Render EMR Dashboard for Medical Staff & SuperAdmin */}
                    {['hr', 'doctor', 'nurse', 'lab_scientist', 'pharmacist', 'superadmin'].includes(user.role) && (
                        <div style={{ marginBottom: '4rem' }}>
                            <EMRDashboard user={user} />
                        </div>
                    )}

                    {/* eCommerce Dashboard for Admin & SuperAdmin */}
                    {['admin', 'superadmin', 'pharmacist'].includes(user.role) && (
                        <>
                            {/* Period Selector */}
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                        ...
                                        <div style={{ textAlign: 'left' }}>
                                            ...
                                            <p style={{
                                                ...
                                                {showCouponSection ? 'Click to collapse' : 'Manage discounts and offers'}
                                            </p>
                                        </div>
                                    </div>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                        <div style={{
                                            padding: '0.5rem 1rem',
                                            backgroundColor: showCouponSection ? '#D4AF37' : '#F0F0F0',
                                            borderRadius: '20px',
                                            color: showCouponSection ? '#1A1A1A' : '#888888',
                                            fontWeight: '700',
                                            fontSize: '0.9rem',
                                            transition: 'all 0.3s ease'
                                        }}>
                                        ...
                                        <ChevronDown
                                            size={28}
                                            color={showCouponSection ? '#D4AF37' : '#888888'}
                                            style={{
                            ...
                            <div style={{
                                ...
                                <button
                                    onClick={() => setShowBlogSection(!showBlogSection)}
                                    style={{
                                        width: '100%',
                                        display: 'flex',
                                        alignItems: 'center',
                                        ...
                                        border: 'none',
                                        cursor: 'pointer',
                                        borderBottom: showBlogSection ? '1px solid #E0E0E0' : 'none',
                                        backgroundColor: showBlogSection ? '#FAFAFA' : '#FFFFFF',
                                        transition: 'all 0.3s ease'
                                    }}
                                >
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                        ...
                                        <div style={{ textAlign: 'left' }}>
                                            ...
                                            <p style={{
                                                ...
                                                {showBlogSection ? 'Click to collapse' : 'Manage blog posts and news'}
                                            </p>
                                        </div>
                                    </div>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                        <ChevronDown
                                            size={28}
                                            color={showBlogSection ? '#D4AF37' : '#888888'}
                                            style={{
                                                transform: showBlogSection ? 'rotate(180deg)' : 'rotate(0deg)',
                                                transition: 'transform 0.4s ease'
                                            }}
                                        />
                                    </div>
                                ...
                                <div style={{
                                    maxHeight: showBlogSection ? '5000px' : '0',
                                    opacity: showBlogSection ? 1 : 0,
                                    overflow: showBlogSection ? 'visible' : 'hidden',
                                    transition: 'max-height 0.8s ease, opacity 0.4s ease, padding 0.4s ease',
                                    padding: showBlogSection ? '2rem' : '0 2rem'
                                }}>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '1.5rem' }}>
                                        {blogs.map(blog => (
                                            <div key={blog._id} style={{
                                                ...
                                                overflow: 'hidden',
                                                transition: 'all 0.3s ease',
                                                opacity: blog.isActive ? 1 : 0.6
                                            }}>
                                                <div style={{ height: '160px', overflow: 'hidden', position: 'relative' }}>
                                                    <img src={blog.link} alt="Blog Thumbnail" style={{ width: '100%', height: '100%', objectFit: 'cover' }}
                                                    ...
                                                    {!blog.isActive && (
                                                        <div style={{
                                                            ...
                                                            <span style={{ color: '#fff', fontWeight: 'bold', border: '2px solid #fff', padding: '0.25rem 0.75rem', borderRadius: '4px' }}>INACTIVE</span>
                                                        </div>
                                                    )}
                                                </div>
                                                <div style={{ padding: '1.5rem' }}>
                                                    <h4 style={{ fontSize: '1.1rem', fontWeight: '700', marginBottom: '0.5rem', lineHeight: '1.4', height: '3rem', overflow: 'hidden' }}>
                                                        {blog.caption}
                                                    </h4>
                                                    ...
                                                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                                                        <button
                                                            ...
                                                            style={{
                                                                ...
                                                                borderRadius: '6px',
                                                                border: '1px solid #E5E7EB',
                                                                background: blog.isActive ? '#FEF2F2' : '#ECFDF5',
                                                                color: blog.isActive ? '#EF4444' : '#10B981',
                                                                fontWeight: '600',
                                                                cursor: 'pointer'
                                                            }}
                                                        >

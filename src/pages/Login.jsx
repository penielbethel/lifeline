                    ...
                    <div className="max-w-md mx-auto">
                        <div className="glass-card p-8" style={{ background: 'white', color: 'inherit', border: '1px solid #eee' }}>
                            <div className="text-center mb-8">
                                ...
                                <p className="text-sm text-gray">{isRegister ? 'Create a new administrator account using a valid token.' : 'Secure login for Lifeline Healthcare Global Options administrators and superadmins.'}</p>
                            </div>
                            ...
                            <form onSubmit={isRegister ? handleRegister : handleLogin} className="modern-form">
                                ...
                                {isRegister && (
                                    <div className="form-group mb-6">
                                        <label className="font-semibold mb-2 block" style={{ color: '#1A1A1A' }}>Role</label>
                                        <div className="relative">
                                            <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray" size={18} />
                                            <select
                                                name="role"
                                                ...
                                                value={formData.role}
                                                onChange={handleChange}
                                                className="px-12 bg-light border-transparent focus:border-gold w-full py-3 rounded-xl"
                                                style={{ color: 'black' }}
                                            >

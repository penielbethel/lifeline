...
const Partners = () => {
    useEffect(() => {
        document.title = "Partners | Lifeline Healthcare Global Options - Collaborative Agricultural Innovation";
    }, []);
    return (
                ...
                <div className="container">
                    <div className="text-center mb-16">
                        ...
                        <p className="max-w-3xl mx-auto">
                            Lifeline Healthcare Global Options operates a partnership-driven model. We believe that by working with the right people in the right places, we can scale our impact across the entire agricultural value chain.
                        </p>
                    </div>

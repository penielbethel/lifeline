...
const Investments = () => {
    useEffect(() => {
        document.title = "Investments | Lifeline Healthcare Global Options - Strategic Growth and Industrial Opportunities";
    }, []);
    return (
                ...
                <div className="container">
                    <div className="text-center mb-12">
                        ...
                        <p className="max-w-3xl mx-auto">
                            At Lifeline Healthcare Global Options, we don't just invest capital; we invest in the future of the African economy.
            ...
            <section className="section bg-black text-white relative overflow-hidden">
                ...
                <div className="container relative z-10">
                    <div className="max-w-2xl">
                        <h2 className="text-gold mb-6">Partner With Lifeline Healthcare Global Options</h2>

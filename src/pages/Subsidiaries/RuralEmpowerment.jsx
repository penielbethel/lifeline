...
const RuralEmpowerment = () => {
    return (
        <>
            ...
            {/* Hero */}
            <Hero
                title="Lifeline Rural Empowerment Initiative"
                subtitle="Empowering rural farmers through sustainable agricultural training and market linkages."
                bgImage="https://images.unsplash.com/photo-1500937386664-56d1dfef3854?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80"
            ...
            <Footer
                companyName="Lifeline Rural Empowerment Initiative"

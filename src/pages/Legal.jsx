            ...
            <section className="section" style={{ paddingTop: '8rem' }}>
                <div className="container" style={{ maxWidth: '800px' }}>
                    ...
                    <div className="mb-12">
                        ...
                        <p className="mb-4">
                            At Lifeline Healthcare Global Options, we are committed to protecting your privacy. This policy explains how we collect and use your data when you visit our website or use our services.
                        </p>
                    ...
                    <div className="mb-12">
                        ...
                        <p className="mb-4">
                            Payments for orders placed through the Lifeline Marketplace are handled via direct bank transfer or other manual methods as communicated by our agents.
                        </p>
                    </div>

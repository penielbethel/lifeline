...
const About = () => {
    useEffect(() => {
        document.title = "About Us | Lifeline Healthcare Global Options - Our Mission and Agricultural Vision";
        window.scrollTo(0, 0);
    }, []);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div style={{ position: 'relative' }}>
                            ...
                            <img
                                ...
                                alt="Lifeline Healthcare Global Options Team"
                                style={{
                                    borderRadius: '20px',
                        ...
                        <div>
                            ...
                            <p style={{ fontSize: '1.1rem', color: '#555', lineHeight: '1.8', marginBottom: '1.5rem' }}>
                                Founded with a vision to revolutionize the agricultural landscape in Nigeria, <strong>Lifeline Healthcare Global Options</strong> has grown from a visionary idea into a multifaceted conglomerate.
                            </p>
            ...
            <section className="section" style={{ textAlign: 'center', padding: '6rem 0' }}>
                <div className="container">
                    ...
                    <p style={{ maxWidth: '600px', margin: '0 auto 2.5rem', fontSize: '1.1rem', color: '#666' }}>
                        Whether you are an investor, a distributor, or a farmer, there is a place for you in the Lifeline Healthcare Global Options ecosystem.
                    </p>

...
const Blog = () => {
    ...
    useEffect(() => {
        document.title = "Blog | Lifeline Healthcare Global Options";
        window.scrollTo(0, 0);
        fetchBlogs();
    }, []);
            ...
            <section style={{
                ...
                <div style={{
                    ...
                    <p style={{
                        ...
                        Stay informed with the latest news, trends, and updates from the Lifeline Healthcare Global Options ecosystem — agriculture, investments, and sustainable growth.
                    </p>
                </div>
            </section>
                    ...
                    {loading ? (
                        ...
                        <div style={{
                            ...
                            <p style={{ color: '#6B7280', maxWidth: '400px', margin: '0 auto', lineHeight: '1.7' }}>
                                Check back soon for the latest news and updates from Lifeline Healthcare Global Options Multi-ventures.
                            </p>
                        </div>
                    )}
                </div>

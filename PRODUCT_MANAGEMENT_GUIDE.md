...
1. **Login as Admin** at https://lifelineglobaloption.vercel.app/login
2. **Open Browser Console** (F12 or Right-click → Inspect → Console)
3. **Paste and run this code**:

```javascript
const token = localStorage.getItem('renee_token');
fetch('https://lifelineglobaloption.vercel.app/api/admin/products/initialize', {
  method: 'POST',
  headers: {
...
Invoke-RestMethod -Uri "https://lifelineglobaloption.vercel.app/api/admin/products/initialize" -Method POST -Headers $headers
```

### Option 3: Using Postman or Thunder Client

1. **Method**: POST
2. **URL**: `https://lifelineglobaloption.vercel.app/api/admin/products/initialize`
3. **Headers**: 
...
1. **Go to Admin Dashboard** (https://lifelineglobaloption.vercel.app/admin-dashboard)
...
1. **Go to Shop Page** (https://lifelineglobaloption.vercel.app/shop)
